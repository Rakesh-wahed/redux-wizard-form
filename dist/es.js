...
import { reduxForm as reduxForm$1 } from 'redux-form';
...
var WizardStepComponent = function (_Component) {
  ...
  function WizardStepComponent(props) {
    ...
    _this.WizardStepForm = reduxForm$1(formOptions)(function (formProps) {
      return React.createElement(
        Wrapper$1,
...
export { WizardForm, WizardStep, WizardSteps, WizardNavigation, wizardReducer };
